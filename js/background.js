var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/ford-gt40-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/ford-gt40-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/ford-gt40-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/ford-gt40-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Ford GT 40?",
				description: "Get awesome Ford GT 40 HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
